---
name: metagpt
description: Orchestrator - Prompt decomposition and workflow coordination
tools: None (orchestration only)
model: claude-sonnet-4.5
complexity: intermediate
argument-hint: [task_description]
allowed-tools: None (orchestration only)
---

# Purpose
Orchestrator - Prompt decomposition and workflow coordination
...
- Check kb_metagpt-manifest.md before reasoning
...
## Workflow
1. Check KB manifest (kb_metagpt-manifest.md)
...
## Examples
USE WHEN: Automatic on braindump prompts
