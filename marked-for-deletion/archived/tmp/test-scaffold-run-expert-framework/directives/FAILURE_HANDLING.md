...
AFTER failure resolution:
  ...
  REQUIRED_ACTIONS:
    - Log to: /Volumes/uss/cloudworkspace/0_operator/1_Inbox/taskholder/th_agent-EXPERT-framework/eval/failure_analysis.md
    - Include:
      • What failed
      • Why it failed
      • How it was resolved
...
```
1. Save as: /Volumes/uss/cloudworkspace/0_operator/1_Inbox/taskholder/th_agent-EXPERT-framework/directives/FAILURE_HANDLING.md
2. Reference in: ALL agent {{SYSTEM_INSTRUCTIONS_MD}} files
3. Enforcement by: {{METAGPT}} error handlers
4. Log failures to: /Volumes/uss/cloudworkspace/0_operator/1_Inbox/taskholder/th_agent-EXPERT-framework/sessions/failures/{{FAILURE_ID}}.json
5. Track patterns in: /Volumes/uss/cloudworkspace/0_operator/1_Inbox/taskholder/th_agent-EXPERT-framework/eval/failure_analysis.md
6. Configure in: /Volumes/uss/cloudworkspace/0_operator/1_Inbox/taskholder/th_agent-EXPERT-framework/.env
   - RETRY_LIMIT={{COUNT}}
...
[ ] /Volumes/uss/cloudworkspace/0_operator/1_Inbox/taskholder/th_agent-EXPERT-framework directory created
...
```
CREATE these in /Volumes/uss/cloudworkspace/0_operator/1_Inbox/taskholder/th_agent-EXPERT-framework:
...
REPLACE all {{PLACEHOLDERS}} with:
  - /Volumes/uss/cloudworkspace/0_operator/1_Inbox/taskholder/th_agent-EXPERT-framework → actual project path
