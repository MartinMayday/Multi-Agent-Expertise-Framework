...
```
1. Save as: /Volumes/uss/cloudworkspace/0_operator/1_Inbox/taskholder/th_agent-EXPERT-framework/directives/HANDOFF_PROTOCOL.md
2. Reference in: ALL agent {{SYSTEM_INSTRUCTIONS_MD}} files
3. Enforcement by: {{METAGPT}} at agent transitions
4. State tracking: /Volumes/uss/cloudworkspace/0_operator/1_Inbox/taskholder/th_agent-EXPERT-framework/sessions/workflows/{{WORKFLOW_ID}}/state.json
5. Log handoffs to: /Volumes/uss/cloudworkspace/0_operator/1_Inbox/taskholder/th_agent-EXPERT-framework/sessions/workflows/{{WORKFLOW_ID}}/handoffs.log
```
