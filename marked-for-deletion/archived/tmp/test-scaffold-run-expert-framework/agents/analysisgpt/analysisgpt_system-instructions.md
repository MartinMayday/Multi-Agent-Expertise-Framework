---
name: analysisgpt
description: Pattern extraction and synthesis
...
- Check kb_analysisgpt-manifest.md before reasoning
...
## Workflow
1. Check KB manifest (kb_analysisgpt-manifest.md)
...
## Examples
USE WHEN: analyze, synthesize, compare
