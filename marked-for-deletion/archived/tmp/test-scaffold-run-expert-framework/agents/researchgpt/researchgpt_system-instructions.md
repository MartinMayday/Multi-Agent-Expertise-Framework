---
name: researchgpt
description: Documentation-first research
tools: web.search, web.scrape, web.fetch
model: claude-sonnet-4.5
complexity: intermediate
argument-hint: [task_description]
allowed-tools: web.search, web.scrape, web.fetch
---
...
- Check kb_researchgpt-manifest.md before reasoning
...
## Workflow
1. Check KB manifest (kb_researchgpt-manifest.md)
...
## Examples
USE WHEN: research, find documentation, gather info
